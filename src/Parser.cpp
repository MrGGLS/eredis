...
incr_result::incr_result(int optype, const std::string &result, const std::string &key)
    : op_result(optype, result)
    , key(key)
{
}
...
decr_result::decr_result(int optype, const std::string &result, const std::string &key)
    : op_result(optype, result)
    , key(key)
{
}
...
lpop_result::lpop_result(int optype, const std::string &result, const std::string &key)
    : op_result(optype, result)
    , key(key)
{
}
...
rpop_result::rpop_result(int optype, const std::string &result, const std::string &key)
    : op_result(optype, result)
    , key(key)
{
}
...
lindex_result::lindex_result(int optype, const std::string &result, const std::string &key, int index)
    : op_result(optype, result)
    , key(key)
    , index(index)
{
...
llen_result::llen_result(int optype, const std::string &result, const std::string &key)
    : op_result(optype,
        result)
    , key(key)
{
...
save_result::save_result(int optype, const std::string &result)
    : op_result(optype, result)
{
}

expire_result::expire_result(int optype, const std::string &result, const std::string &key, int time)
    : op_result(
        optype, result)
    , key(key)
    , time(time)
...
ttl_key_result::ttl_key_result(int optype, const std::string &result, const std::string &key)
    : op_result(optype,
        result)
    , key(key)
{
